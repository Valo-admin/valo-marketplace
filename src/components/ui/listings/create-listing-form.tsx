        ...
        <div className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          <div className="mb-6">
            ...
            <h2 className="mt-3 text-2xl font-semibold text-slate-900">
              Describe tu pieza como un lote premium
            </h2>
          </div>
          ...
          <div className="grid gap-5">
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows={6}
                placeholder="Incluye contexto, estado, detalles visuales, defectos y cualquier atributo relevante."
                className="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none transition focus:border-amber-500"
              />
            </div>
